...
2. 画面の Filter または ブラウザのページ内検索機能で対象を検索。
3. vesions からバージョンを指定（初期値は最新版です）。
4. Build Tool から Gradle, Maven 等を選択
5. Build Tool のテキストをコピーし利用する。
